 ...
 */
data class ArtistApi(@SerializedName("artistType") val type: String,
                     @SerializedName("artistType") val name: String,
                     ...
                     @SerializedName("primaryGenreId") val genreId: String) : BaseResponse()